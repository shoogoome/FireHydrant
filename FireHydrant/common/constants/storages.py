...
FIRE_HYDRANT_DATA_FACEC_DISTINGUISH = FIRE_HYDRANT_DATA_FACEC + "/distinguish"
FIRE_HYDRANT_DATA_FACEC_DISTINGUISH_STATIC = FIRE_HYDRANT_DATA_FACEC_DISTINGUISH + "/static"
...
STORAGE_MAPPING = {
    ...
    'facec_distinguish_static': FIRE_HYDRANT_DATA_FACEC_DISTINGUISH_STATIC,
    'facec_distinguish': FIRE_HYDRANT_DATA_FACEC_DISTINGUISH,
