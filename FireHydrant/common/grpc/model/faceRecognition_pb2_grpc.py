...
class FaceRecognitionStub(object):
  ...
  def __init__(self, channel):
    ...
    """
    self.update_library = channel.unary_unary(
        '/faceRecognition.FaceRecognition/update_library',
...
def add_FaceRecognitionServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'update_library': grpc.unary_unary_rpc_method_handler(
          servicer.update_library,
