...
class PracticeTeacherToStudentInfoView(FireHydrantView):
    ...
    def get(self, request, sid, cid, eid):
        ...
        :return:
        """
        logic = EvaluateTeacherToStudentLogic(self.auth, sid, cid, eid)
    ...
    def post(self, request, sid, cid):
        ...
        :return:
        """
        logic = EvaluateTeacherToStudentLogic(self.auth, sid, cid)
        ...
        for student in students:
            ...
            try:
                with transaction.atomic():
                    PracticeEvaluateTeacherToStudent.objects.create(
                        author=teacher,
...
class PracticeTeacherToStudentListMgetView(FireHydrantView):
    ...
    def post(self, request, sid, cid):
        ...
        data = []
        evaluates = PracticeEvaluateTeacherToStudent.objects.get_many(ids)
