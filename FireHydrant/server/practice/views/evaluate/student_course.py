...
from ...logics.evaluate import EvaluateStudentToCourseLogic
from ...models import PracticeEvaluateStudentToCourse
from common.utils.helper.pagination import slicer
from ...logics.course import CourseLogic
from django.db.models import Q

class PracticeStudentToCourseInfoView(FireHydrantView):
    ...
    def get(self, request, sid, cid, eid):
        ...
        :return:
        """
        logic = EvaluateStudentToCourseLogic(self.auth, sid, cid, eid)
    ...
    def post(self, request, sid, cid):
        ...
        :return:
        """
        logic = EvaluateStudentToCourseLogic(self.auth, sid, cid)
        ...
        for student in students:
            ...
            try:
                with transaction.atomic():
                    PracticeEvaluateStudentToCourse.objects.create(
                        author=student,
...
class PracticeStudentToCourseListMget(FireHydrantView):
    ...
    def get(self, request, sid, cid):
        ...
        evaluates = PracticeEvaluateStudentToCourse.objects.filter(course_id=cid).values('id', 'update_time')
        if params.has('star'):
    ...
    def post(self, request, sid, cid):
        ...
        data = []
        evaluates = PracticeEvaluateStudentToCourse.objects.get_many(ids)
